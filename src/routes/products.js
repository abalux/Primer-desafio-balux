...
router.post("/", async (req, res) => {
  ...
  if ((!title, !description, !code, !price, !stock, !id)) {
...
router.put("/:pid", async (req, res) => {
    ...
    const {
      ...
      const newProduct = {title, description, code, price, status, stock, id}
...
router.delete("/:pid", async (req, res) => {
    ...
    res.json({message: "success. El producto se ha eliminado", data: response})
})
